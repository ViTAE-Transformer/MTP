...
test_evaluator = dict(
    type='DOTAMetric',
    outfile_prefix = '/work/share/achk2o1zg1/diwang22/work_dir/multitask_pretrain/finetune/Rotated_Detection/fair1m20/oriented_rcnn_rvsa_b_800_mae_mtp_fair1m20_branches_reuse_decaoder/submit/oriented_rcnn_rvsa_b_800_mae_mtp_fair1m20_branches_reuse_decaoder',
    format_only=True,
    merge_patches=True)
