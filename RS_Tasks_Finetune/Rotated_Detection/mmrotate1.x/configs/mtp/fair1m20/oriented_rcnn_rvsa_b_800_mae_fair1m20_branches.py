...
test_evaluator = dict(
    type='DOTAMetric',
    outfile_prefix = '/work/share/achk2o1zg1/diwang22/work_dir/multitask_pretrain/finetune/Rotated_Detection/fair1mv2/oriented_rcnn_rvsa_b_800_mae_fair1m20_branches/submit/oriented_rcnn_rvsa_b_800_mae_fair1m20_branches',
    format_only=True,
    merge_patches=True)
...
model = dict(
    ...
    backbone=dict(
        ...
        pretrained =  '/work/home/acdtzwus6v/dw/pretrn/vit-b-checkpoint-1599.pth',
        ),
    neck=dict(
        type='mmdet.FPN',
