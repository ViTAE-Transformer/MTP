...
test_evaluator = dict(
    type='DOTAMetric',
    outfile_prefix = '/data/diwang22/code/RS-MTP-workdir/finetune/Rotated_Detection/dotav1_ms/oriented_rcnn_rvsa_b_1024_mae_mtp_dota10/test/submit/oriented_rcnn_rvsa_b_1024_mae_mtp_dota10',
    format_only=True,
    merge_patches=True)
...
model = dict(
    ...
    backbone=dict(
        ...
        pretrained =  '/data/diwang22/code/pretrn/last_vit_b_rvsa_ss_is_rd_pretrn_model_encoder.pth'
        ),
    neck=dict(
        type='mmdet.FPN',
