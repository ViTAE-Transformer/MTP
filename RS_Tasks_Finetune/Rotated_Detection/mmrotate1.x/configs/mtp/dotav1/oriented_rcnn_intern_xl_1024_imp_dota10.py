...
test_evaluator = dict(
    type='DOTAMetric',
    outfile_prefix = '/data/diwang22/code/RS-MTP-workdir/finetune/Rotated_Detection/dotav1_ms/oriented_rcnn_intern_xl_1024_imp_dota10/test/submit/oriented_rcnn_intern_xl_1024_imp_dota10',
    format_only=True,
    merge_patches=True)
