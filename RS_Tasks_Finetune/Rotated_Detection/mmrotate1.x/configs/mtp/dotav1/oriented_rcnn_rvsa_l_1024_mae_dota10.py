...
test_evaluator = dict(
    type='DOTAMetric',
    outfile_prefix = '/data/diwang22/code/RS-MTP-workdir/finetune/Rotated_Detection/dotav1_ms/oriented_rcnn_rvsa_l_1024_mae_dota10/test/submit/oriented_rcnn_rvsa_l_1024_mae_dota10',
    format_only=True,
    merge_patches=True)
