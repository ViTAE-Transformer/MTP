...
test_evaluator = dict(
    type='DOTAMetric',
    outfile_prefix = '/data/diwang22/code/RS-MTP-workdir/finetune/Rotated_Detection/dotav2_ss/oriented_rcnn_intern_xl_1024_imp_dota20/test/submit/oriented_rcnn_intern_xl_1024_imp_dota20',
    format_only=True,
    merge_patches=True)
...
model = dict(
    ...
    backbone=dict(
        ...
        with_cp=True,
        out_indices=(0, 1, 2, 3),
        pretrained = '/data/diwang22/code/pretrn/internimage_xl_22kto1k_384.pth',
        ),
    neck=dict(
        type='mmdet.FPN',
