...
from mmrotate.registry import TASK_UTILS as ROD_TASK_UTILS
...
from .dense_head import MTP_RD_BaseDenseHead



@MODELS.register_module()
class MTP_RD_AnchorHead(MTP_RD_BaseDenseHead):
    ...
    def __init__(
        ...
        self.bbox_coder = ROD_TASK_UTILS.build(bbox_coder)
