...
from mmrotate.models.task_modules.assigners.rotate_iou2d_calculator import cast_tensor_type

@TASK_UTILS.register_module()
class MTP_RD_RBbox2HBboxOverlaps2D:
...
@TASK_UTILS.register_module()
class MTP_RD_MaxIoUAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        """
        gt_bboxes = gt_instances.rboxes
        priors = pred_instances.priors
        gt_labels = gt_instances.rlabels
        if gt_instances_ignore is not None:
            gt_bboxes_ignore = gt_instances_ignore.rbboxes
        else:
