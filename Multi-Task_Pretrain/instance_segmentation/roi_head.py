...
class MTP_IS_StandardRoIHead(BaseRoIHead):
    ...
    def loss(x, sampling_results) -> dict:
    ...
    def gen_sampling_results(self, tbr) -> dict:
        ...
        return sampling_results, batch_gt_instances
    ...
    def mask_loss(self, mask_results,
    ...
    def test_mask_generate_rois(self, results_list):
    ...
    def test_mask_roi_feats(self, x,
                      rois: Tensor = None,
