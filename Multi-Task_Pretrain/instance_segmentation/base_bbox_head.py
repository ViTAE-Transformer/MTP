...
class MTP_IS_BBoxHead(BaseModule):
    ...
    def __init__(self,
        ...
        #self.loss_cls = nn.CrossEntropyLoss().cuda()
    ...
    def _get_targets_single(self, num_classes, pos_priors: Tensor, neg_priors: Tensor,
    ...
    def get_targets(self,
        ...
        num_classes_list = [num_classes for res in sampling_results]
    ...
    def loss_and_target(self,
        ...
        cls_reg_targets = self.get_targets(num_classes,
    ...
    def refine_bboxes(self, num_classes, sampling_results: Union[List[SamplingResult],
                                                    InstanceList],
                      bbox_results: dict,
